...
<div class="container" style="margin-left: 380px;">
    <div class="row">
        <div class="col s6">
          ...
          <span class="white-text flow-text">Categories Based on Lost
          </span>
                        <br>
                        <br>
                        <a href="categorylist.php?categoryvalue=lost" class="btn">Visit</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col s6">
            <div class="">
                <div class=" ">
                    <div class="card-panel blue-grey darken-4 z-depth-5">
          <span class="white-text flow-text">Categories Based on Found
          </span>
                        <br>
                        <br>
                        <a href="categorylist.php?categoryvalue=found" class="btn">Visit</a>
                    </div>
                </div>
            </div>
        </div>
