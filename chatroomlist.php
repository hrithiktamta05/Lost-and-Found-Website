...
<div class="container" style="margin-left: 380px;">
    <div class="row">
        <div class="col s6">
          ...
          <span class="white-text flow-text">Chatroom
          </span>
                        <br>
                        <br>
                        <a href="chatroom.php" class="btn">VISIT</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col s6">
            <div class="">
                <div class="">
                    <div class="card-panel blue-grey darken-4 z-depth-5">
          <span class="white-text flow-text">Mumbai Region Chatroom
          </span>
                        <br>
                        <br>
                        <a href="mumbaichatroom.php" class="btn">VISIT</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col s6">
            <div class="">
                <div class="">
                    <div class="card-panel blue-grey darken-4 z-depth-5">
          <span class="white-text flow-text">Navi Mumbai Region Chatroom
          </span>
                        <br>
                        <br>
                        <a href="navimumbaichatroom.php" class="btn">VISIT</a>
                    </div>
                </div>
            </div>
        </div>
