    ...
    <div class="row">
        <div class="col s6">
            <div class="">
                <div class="">
                    <div class="card-panel blue-grey darken-4 z-depth-5">
          <span class="white-text flow-text">Global Lost and Found
          </span>
                        <br>
                        <br>
                        <a href="allitemlist.php" class="btn">View</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col s6">
            <div class="">
                <div class="">
                    <div class="card-panel blue-grey darken-4 z-depth-5">
          <span class="white-text flow-text">View Category Wise Lost and Found
          </span>
                        <br>
                        <br>
                        <a href="categorywisesearch.php" class="btn">View</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col s6">
            <div class="">
                <div class="">
                    <div class="card-panel blue-grey darken-4 z-depth-5">
          <span class="white-text flow-text">Visit Chatrooms
          </span>
                        <br>
                        <br>
                        <a href="chatroomlist.php" class="btn">Chatroom</a>
                    </div>
                </div>
            </div>
        </div>
