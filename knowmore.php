...
if (isset($_GET['id'])) {
    ...
    $email = $row['uemail'];
    $displayEmail = "";
    for($i=0; $i<strlen(explode("@", $email)[0]); $i++){
        $displayEmail .= "x";
    }
    $displayEmail = $displayEmail . '@' . explode("@", $email)[1];
        ...
        <div class="col l6 s12 blue darken-3" style="border-radius: 30px;">
            <div class="container">
                <div class="row">
                    ...
                    <div class=\"col s12 white-text\" style=\"font-weight: 100;\">$displayEmail</div>
                    <div class=\"col s12 white-text\" style=\"font-weight: 430;margin-top: 10px;\">$cat</div>
                    <div class=\"col s12 white-text\" style=\"font-weight: 300;\">+91$displayPhone<a aria-label='Chat on WhatsApp' href='https://wa.me/91$phone'> <img alt='Chat on WhatsApp' src='image/whatsapp.png' width='20' height='20'/></div>
