...
div#chatbox {
        ...
        <div id="wrapper" style="background: white;width: 50%;padding: 1%;margin: 0 25%;">
            <div id="menu">
                <u><p class="welcome">Welcome, <b><?php echo $_SESSION['login_user']; ?> to NAVI MUMBAI Region Chatroom</b></p></u>
            </div>
            <div id="chatbox">
            <?php
            if(file_exists("NaviMumbailog.html") && filesize("NaviMumbailog.html") > 0){
                $contents = file_get_contents("NaviMumbailog.html");          
                echo $contents;
            }
            ?>
            </div>
            <form name="message" action="">
                <input type='hidden' name='regionName' id='regionName' value='NaviMumbai'/>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                $("#submitmsg").click(function () {
                    ...
                    $.post("post.php", { text: clientmsg , regionName: regionName});
                    $("#usermsg").val("");
                    return false;
                });
                function loadLog() {
